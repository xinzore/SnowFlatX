<?php
/*
	SnowFlatX Theme for Question2Answer Package
	Copyright (C) 2023 Xinzore <https://xinzore.github.io>

	File:           qa-theme.php
	Version:        SnowFlatX 1.8
 ...
 * 
 * @author Q2A Market <https://xinzore.github.io>
 * @copyright (c) 2023, Xinzore
 * @license http://www.gnu.org/copyleft/gpl.html
 */
class qa_html_theme extends qa_html_theme_base
{
	protected $theme = 'SnowFlatX';
	...
	public function attribution()
	{
		...
		$this->output(
			...
			'SnowFlatX Theme by <a href="https://xinzore.github.io">Xinzore</a>',
			'</div>'
		);
		parent::attribution();
	}
